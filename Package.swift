...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "AppsFlyerLib123", url: "https://github.com/AppsFlyerSDK/AppsFlyerFramework-Static.git",  .exact("6.12.0")),
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [ 
                            ...
                            .product(name: "AppsFlyerLib-Static", package: "AppsFlyerLib123"),],
